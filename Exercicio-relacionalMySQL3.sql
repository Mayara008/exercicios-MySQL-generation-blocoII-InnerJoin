...
insert into tb_categoria (tipo, tarja, setor) values ("Espirro e Dor", "Amarela", "Infantil/Adulto");
insert into tb_categoria (tipo, tarja, setor) values ("engordar", "Natural", "Adulto");
...
insert into tb_remedio (nome, uso, preco, categoria, categoria_id) values ("Fluoxetina", "oral", 99.99, "Original", 5);
insert into tb_remedio (nome, uso, preco, categoria, categoria_id) values ("Buscofem", "oral", 58.99, "Original", 2);
insert into tb_remedio (nome, uso, preco, categoria, categoria_id) values ("Paroxetina", "oral", 98.99, "Original", 5);
insert into tb_remedio (nome, uso, preco, categoria, categoria_id) values ("Ponstan", "oral", 5.99, "Genérico", 2);
insert into tb_remedio (nome, uso, preco, categoria, categoria_id) values ("Azitromicina", "oral", 26.99, "Genérico", 1);
insert into tb_remedio (nome, uso, preco, categoria, categoria_id) values ("Orlislat", "oral", 76.99, "Original", 3);
